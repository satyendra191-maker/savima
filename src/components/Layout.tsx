                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 mb-12">
                    ...
                    <div>
                        ...
                        <div className="mt-4 pt-4 border-t border-slate-700">
                            <p className="text-xs text-slate-400 mb-3">Payment Partners</p>
                            <div className="flex flex-wrap gap-2">
                                <span className="px-2 py-1 bg-slate-800 rounded text-xs text-slate-300">Razorpay</span>
                                <span className="px-2 py-1 bg-slate-800 rounded text-xs text-slate-300">Stripe</span>
                                <span className="px-2 py-1 bg-slate-800 rounded text-xs text-slate-300">PayPal</span>
                                <span className="px-2 py-1 bg-slate-800 rounded text-xs text-slate-300">UPI</span>
                            </div>
                        </div>
                    </div>
